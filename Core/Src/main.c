...
#define TRUE        (1)
#define FALSE       (0)
#define QUEUE_SIZE  (100)		//order of moving average filter


//24bit spi sender for adl5960 control(DMA use)
void spi_write_32(uint16_t address, uint8_t writedata){
